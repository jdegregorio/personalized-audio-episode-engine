...
| --- | --- | --- |
| `collection-request` | [`collection-request-v1.0.schema.json`](../schemas/collection-request-v1.0.schema.json) | Topic-generic collection scope, limits, capability hints, and output location |
...
Unknown required versions fail with `unsupported_version`. Adding compatible optional fields requires an intentional model/schema update and contract tests; incompatible changes require a new contract version.
