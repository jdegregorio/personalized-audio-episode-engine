"""Validate and record one of at most two grounded script attempts."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        result = record_script_attempt(
            ...
            candidate_path=context.workspace.run_directory / "episode-script.json",
        ...
        return 1
    except (ScriptwritingError, LifecycleError) as error:
        print(_error("script_record_failed", str(error)), file=sys.stderr)
        return 1
