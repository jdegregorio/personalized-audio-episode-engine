"""Assemble rendered TTS segments into one validated publication-ready MP3."""
...
from audio_engine.audio import AudioAssemblyError, assemble_final_audio, open_audio_run
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        print(_error("audio_assembly_failed", str(error)), file=sys.stderr)
        return 1
